#!/usr/bin/env node
/** Apply migration 439 math hub worksheets via service role */
...
const specs = [
  ['/games/math/math-decimal-hub/index.html', '/games/math/math-decimal-hub-worksheet.html', '📝 ใบงานคลังทศนิยม ป.4–ป.5', 'ใบงาน A4 คู่คลังทศนิยม อ่านค่า เปรียบเทียบ บวกลบ และเงินบาท/สตางค์', '/games/math/math-decimal-hub/cover.png', 'คณิตศาสตร์', ['ป.4', 'ป.5'], ['ใบงาน', 'hub', 'ทศนิยม', 'พิมพ์ได้'], 163],
  ['/games/math/math-fraction-hub/index.html', '/games/math/math-fraction-hub-worksheet.html', '📝 ใบงานคลังเศษส่วน ป.4', 'ใบงาน A4 คู่คลังเศษส่วน แท่งเทียบ บวกลบตัวส่วนเท่า และจำนวนคละ', '/games/math/math-fraction-hub/cover.png', 'คณิตศาสตร์', ['ป.4'], ['ใบงาน', 'hub', 'เศษส่วน', 'พิมพ์ได้'], 164],
  ['/games/math/math-geometry-hub/index.html', '/games/math/math-geometry-hub-worksheet.html', '📝 ใบงานคลังเรขาคณิต ป.4–ป.5', 'ใบงาน A4 คู่คลังเรขาคณิต มุม เส้นรอบรูป พื้นที่ และรูปเรขา 2D', '/games/math/math-geometry-hub/cover.png', 'คณิตศาสตร์', ['ป.4', 'ป.5'], ['ใบงาน', 'hub', 'เรขาคณิต', 'พิมพ์ได้'], 165],
];
...
console.log('done migration 439');
