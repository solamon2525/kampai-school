...
window.THREE = {
    ...
    Mesh: class { constructor() { this.position = { set() {}, copy() {}, clone() { return this; }, distanceTo() { return 10; }, add() {}, sub() {} }; this.rotation = { set() {} }; this.scale = { set() {}, setScalar() {} }; this.userData = {}; this.geometry = { translate() {} }; } add() {} remove() {} },
    Group: class { constructor() { this.position = { set() {}, copy() {}, clone() { return this; }, distanceTo() { return 10; } }; this.rotation = { set() {} }; this.scale = { set() {}, setScalar() {} }; this.userData = {}; this.children = []; } add() {} remove() {} },
    PlaneGeometry: class {},
