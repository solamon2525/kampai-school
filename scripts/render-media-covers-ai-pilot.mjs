...
const SPECS = {
  ...
  'thai-literature-hub': {
    ...
    accent: '#a16207',
    scene:
      'male chibi Thai teacher reading Thai folktale to cute elementary students, whiteboard showing open storybook turtle character and running hare, floating scrolls, warm golden yellow literature classroom, Thai decorative patterns, cute bright primary school poster',
  ...
  'thai-writing-hub': {
    ...
    overlay: 'banner',
    title: 'คลังแต่งข้อความ',
    subtitle: 'สรุป · บันทึก · จดหมาย',
    footer: 'ป.4-5 · ภาษาไทย · สื่อการสอน Hub',
    grade: 'ป.4-5',
    accent: '#c2410c',
    scene:
      'male chibi Thai teacher explaining writing structure on a whiteboard, cute pencil and letter envelope icons, checklist with checkboxes, children taking notes in colorful notebooks, warm orange cozy classroom',
    colors: 'main color tone: warm orange, peach, and soft teal',
  },
  'math-word-problem-hub': {
    out: 'public/games/math/math-word-problem-hub/cover.png',
    overlay: 'banner',
    title: 'โจทย์ปัญหาคณิต',
    subtitle: '1-2 ขั้นตอน · อ่านโจทย์ · วิธีทำ',
    footer: 'ป.4-5 · คณิตศาสตร์ · สื่อการสอน Hub',
    grade: 'ป.4-5',
    accent: '#ea580c',
    scene:
      'male chibi Thai teacher showing math word problems on a whiteboard, apples and coins as counting aids, addition subtraction multiplication division signs floating, students thinking with question marks, bright math classroom',
    colors: 'main color tone: warm orange, sunny yellow, and sky blue accents',
  },
  'thai-poetry-hub': {
    out: 'public/games/thai/thai-poetry-hub/cover.png',
    overlay: 'banner',
    title: 'คลังบทร้อยกรองไทย',
    subtitle: 'ร้อยแก้ว · ร้อยกรอง · คำขวัญ · สัมผัส',
    footer: 'ป.4-5 · ภาษาไทย · สื่อการสอน Hub',
    grade: 'ป.4-5',
    accent: '#7e22ce',
    scene:
      'male chibi Thai teacher reading Thai poetry in classroom, whiteboard showing traditional Thai scrolls and verses, pink lotus flowers floating, sparkles and golden stars, elegant purple classroom with Thai art borders',
    colors: 'main color tone: beautiful purple, pastel violet, and soft pink accents',
  },
  'thai-reading-hub': {
    out: 'public/games/thai/thai-reading-hub/cover.png',
    overlay: 'banner',
    title: 'คลังอ่านจับใจความ',
    subtitle: 'เรื่องสั้น · ข่าว · บทความ · ตอบคำถาม',
    footer: 'ป.4-5 · ภาษาไทย · สื่อการสอน Hub',
    grade: 'ป.4-5',
    accent: '#1e40af',
    scene:
      'male chibi Thai teacher pointing to a large open book on a whiteboard, magnifying glass icon examining words, scientific icons like DNA and planets, kids reading happily with book stacks around them, bright blue classroom',
    colors: 'main color tone: bright blue, cozy cream, and soft green accents',
  },
  'thai-sentence-hub': {
    ...
    accent: '#15803d',
    scene:
      'male chibi Thai teacher explaining sentence structure on a whiteboard, showing puzzle blocks labeled Subject Verb Object connected together, cute students raising hands, bright green classroom',
    colors: 'main color tone: fresh green, light yellow, and soft blue',
  },
};
