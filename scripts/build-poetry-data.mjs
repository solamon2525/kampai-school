...
writeFileSync(join(HUB, 'data.js'), `/* AUTO */\nwindow.GAME_DATA = ${JSON.stringify({ categories, words }, null, 2)};\n`, 'utf8');
console.log(`✅ poetry data.js — ${Object.values(words).reduce((s, a) => s + a.length, 0)} items`);
