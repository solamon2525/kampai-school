...
const HUB = join(dirname(fileURLToPath(import.meta.url)), '..', 'public/games/thai/thai-idiom-hub');
...
console.log(`✅ idiom data.js — ${Object.values(words).reduce((s, a) => s + a.length, 0)} items`);
