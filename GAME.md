...
> ต้องผ่านก่อน ship. **Check 9b** เตือนถ้าหัวข้อฝังใน PNG ชิดขอบบน (สระไทยล้น). SVG: ตั้ง `viewBox="0 0 1280 720"` · PNG/JPG: export ที่ 1280×720
...
### ข้อยกเว้นสำหรับปกสื่อการสอน (`*-media`)

ปกสื่อการสอนเป็นโปสเตอร์บทเรียน ไม่ใช่ปกเกมแข่งขัน จึง **อนุญาตให้ใช้ครูผู้สอนผู้ชายหรือผู้หญิงเป็นตัวละครหลักในภาพถ่าย/ภาพสมจริง** พร้อมนักเรียนเป็นบริบทการเรียนรู้ได้ ไม่บังคับใช้ตัวละคร chibi หรือนักเรียนเป็นตัวเอกเหมือนปกเกมทั่วไป แต่ยังต้องรักษาอัตราส่วน 16:9, safe zone, สีสดระดับประถม, และภาพต้องสื่อเนื้อหาบทเรียนได้ทันที
- **ตัวหนังสือ:** ชื่อเกมไทยตัวใหญ่อ่านชัด (ไม่ถูกภาพบัง) + ป้ายเล็ก `{วิชา} {ระดับชั้น}` · โทนสีตามวิชา
- **Safe zone หัวข้อ (สำคัญ):** ห้ามวางหัวข้อไทยชิดขอบบน canvas — ใช้ปุ่ม **"ปก AI"** (overlay Sarabun `y=34`) หรือ banner กลางบนแบบ Kingdom หรือเว้น ≥10% จากขอบบน · `pnpm verify:game` **Check 9b** เตือน · `pnpm fix:covers-safe-top` แก้ปกเก่า
...
**Checklist ก่อนใช้ปก:** [ ] 16:9 · [ ] เด็กนักเรียน + ฉากตรงเกม · [ ] ชื่อไทยถูก+อ่านชัด · [ ] safe zone หัวข้อ ≥10% จากขอบบน (หรือใช้ปก AI) · [ ] สีสดใส · [ ] verify ด้วยตา
