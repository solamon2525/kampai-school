...
(function () {
  ...
  function _injectCss() { if (document.getElementById('kampai-sound-css')) return; var s = document.createElement('style'); s.id = 'kampai-sound-css'; s.textContent =
    ...
    '.ksnd{width:44px;height:44px;border:none;border-radius:50%;cursor:pointer;font-size:17px;line-height:1;background:rgba(15,23,42,.55);-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px);box-shadow:0 2px 8px rgba(0,0,0,.35);transition:opacity .15s,transform .1s;color:#fff;padding:0;font-family:inherit}' +
    '#kbtn-voice{width:auto;min-width:56px;padding:0 10px;border-radius:22px;font-size:12px;font-weight:700;letter-spacing:.02em}' +
    '@media (pointer:coarse){.ksnd{width:44px;height:44px;font-size:15px}#kbtn-voice{min-width:52px;font-size:11px;padding:0 7px}}' +
    '@media (pointer:coarse) and (orientation:landscape){#kampai-snd{bottom:max(8px,env(safe-area-inset-bottom));right:max(8px,env(safe-area-inset-right));gap:4px}.ksnd{width:44px;height:44px;font-size:13px}#kbtn-voice{min-width:48px;font-size:10px;padding:0 5px}}' +
