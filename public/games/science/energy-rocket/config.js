...
window.GAME_CONFIG = {
    ...
    // ── พลัง (charge meter) ──
    CHARGE_K: 0.008,                // ขยับ 1 หน่วยพลัง → เติม charge เท่าไร/เฟรม
    DRAIN: 0.015,                   // ถ้าหยุดนิ่ง charge ไหลลงเท่าไร/เฟรม (บังคับขยับต่อเนื่อง)
    TAP_K: 0.025,                   // แตะปุ่ม "ออกแรง" 1 ครั้ง → เติม charge (fallback/ช่วยเด็กเล็ก)

    // ── เกม ──
    ROUNDS: 6,                      // จำนวนจรวด/ความรู้ (≤ จำนวนใน data.js)
    ROUND_SEC: 20,                  // เวลาเติมพลังต่อรอบ (วินาที)
    BGM: 'cheerful'
};
