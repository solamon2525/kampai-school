...
window.GAME_CONFIG = {
    ...
    BASKET_BOTTOM_PAD: 0.018, // ระยะจากขอบล่างจอ (สัดส่วน H) — ตะกร้าลงล่างแต่เห็นครบ
    ...
    FALL_SPEED: 0.00085,    // ความเร็วตกเริ่มต้น (สัดส่วนจอ/เฟรม)
    FALL_SPEED_INC: 0.0001, // เพิ่มต่อรอบ
    FALL_SPEED_INC_CORRECT: 0.00004, // เพิ่มทุกครั้งที่ตอบถูกในรอบ
    FALL_SPEED_MAX: 0.002,  // ความเร็วสูงสุด
