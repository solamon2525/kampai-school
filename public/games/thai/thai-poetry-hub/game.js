/* game.js — คลังบทร้อยกรรมไทย ป.4-5 */
...
const FLASH_VARIANT_KEY = 'tpy_flash_variant';
...
function flashKnownKey(slug) {
  return `tpy_flash_known_${slug || 'default'}`;
}
...
const GRID_GRADE_KEY = 'tpy_grid_grade';
const GRID_VIEW_KEY = 'tpy_grid_view';
...
function loadClassQuizWord() {
  ...
  document.getElementById('wfront-cat').textContent = 'ท่อง/ตอบ';
...
const AUTO_READ_KEY = 'tpy_auto_read_mode';
const AUTO_PAUSE_MS_KEY = 'tpy_auto_pause_ms';
const AUTO_FLIP_KEY = 'tpy_auto_flip';
const AUTO_SOUND_KEY = 'tpy_auto_sound';
...
if (typeof KampaiMatch !== 'undefined' && KampaiMatch.create) {
  KampaiMatch.create({ slug: (CONFIG && CONFIG.SLUG) || 'thai-poetry-hub' });
}
