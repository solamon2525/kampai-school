...
function loadClassQuizWord() {
  ...
  document.getElementById('wfront-cat').textContent = 'ทายส่วนประโยค';
...
if (typeof KampaiMatch !== 'undefined' && KampaiMatch.create) {
  KampaiMatch.create({ slug: (CONFIG && CONFIG.SLUG) || 'thai-sentence-hub' });
}
