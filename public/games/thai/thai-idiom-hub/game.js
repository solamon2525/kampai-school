...
const FLASH_VARIANT_KEY = 'tih_flash_variant';
...
function flashKnownKey(slug) {
  return `tih_flash_known_${slug || 'default'}`;
}
...
const GRID_GRADE_KEY = 'tih_grid_grade';
const GRID_VIEW_KEY = 'tih_grid_view';
...
function loadClassQuizWord() {
  ...
  document.getElementById('wfront-cat').textContent = 'ทายสำนวน';
...
const AUTO_READ_KEY = 'tih_auto_read_mode';
const AUTO_PAUSE_MS_KEY = 'tih_auto_pause_ms';
const AUTO_FLIP_KEY = 'tih_auto_flip';
const AUTO_SOUND_KEY = 'tih_auto_sound';
...
if (typeof KampaiMatch !== 'undefined' && KampaiMatch.create) {
  KampaiMatch.create({ slug: (CONFIG && CONFIG.SLUG) || 'thai-idiom-hub' });
}
