...
const FLASH_VARIANT_KEY = 'trh_flash_variant';
...
function flashKnownKey(slug) {
  return `trh_flash_known_${slug || 'default'}`;
}
...
const GRID_GRADE_KEY = 'trh_grid_grade';
const GRID_VIEW_KEY = 'trh_grid_view';
...
const AUTO_READ_KEY = 'trh_auto_read_mode';
const AUTO_PAUSE_MS_KEY = 'trh_auto_pause_ms';
const AUTO_FLIP_KEY = 'trh_auto_flip';
const AUTO_SOUND_KEY = 'trh_auto_sound';
...
if (typeof KampaiMatch !== 'undefined' && KampaiMatch.create) {
  KampaiMatch.create({ slug: (CONFIG && CONFIG.SLUG) || 'thai-reading-hub' });
}
