...
const FLASH_VARIANT_KEY = 'tph_flash_variant';
...
function flashKnownKey(slug) {
  return `tph_flash_known_${slug || 'default'}`;
}
...
const GRID_GRADE_KEY = 'tph_grid_grade';
const GRID_VIEW_KEY = 'tph_grid_view';
...
// ═══ MODE 3: POS QUIZ (ทายเครื่องหมาย) ═══
...
function loadClassQuizWord() {
  ...
  document.getElementById('wfront-cat').textContent = 'ทายเครื่องหมาย';
...
const AUTO_READ_KEY = 'tph_auto_read_mode';
const AUTO_PAUSE_MS_KEY = 'tph_auto_pause_ms';
const AUTO_FLIP_KEY = 'tph_auto_flip';
const AUTO_SOUND_KEY = 'tph_auto_sound';
...
if (typeof KampaiMatch !== 'undefined' && KampaiMatch.create) {
  KampaiMatch.create({ slug: (CONFIG && CONFIG.SLUG) || 'thai-punctuation-hub' });
}
