/* game.js — English AR Quiz ป.4 (KAMPAI SDK + KampaiAR engine) */
(function () {
    'use strict';
    ...
    function renderPlayer() {
        ...
        var best = stt ? ' · <b style="color:#93c5fd">สถิติ ' + (stt.personalBest || 0) + '</b>' : '';
    ...
    function loadRound() {
        ...
        if (q.speak) KAMPAI.sound.speak(q.speak, 'en-US');
        ar.setActive(true);
        startTimer();
    }
    function startTimer() {
    ...
    function finishGame() {
        ...
        $('final-detail').textContent = 'จาก ' + ST.questions.length + ' ข้อ · ภาษาอังกฤษ ป.4';
