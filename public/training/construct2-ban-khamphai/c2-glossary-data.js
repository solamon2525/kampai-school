/**
 * c2-glossary-data.js — ฐานข้อมูลคำศัพท์ Construct 2 ครอบคลุมคำแปล เสียงอ่านไทย และเหตุการณ์การใช้งาน
 */
(function(window) {
  'use strict';
  ...
  var GLOSSARY_DATA = [
    ...
    },
    {
      ...
      speechTh: 'อีเวนต์ชีต คือ แผ่นเขียนคำสั่งของเกม เปรียบเหมือนสมองที่คอยสั่งงานว่า เมื่อเกิดเหตุการณ์อะไรขึ้น จะให้เกมทำอะไรต่อไป',
    ...
    },
    {
      ...
      speechTh: 'พร็อปเพอร์ตี้ คือ แถบปรับแต่งค่าต่างๆ ของวัตถุที่เลือก เช่น ปรับขนาด ตำแหน่ง ความเร็ว หรือการใส่พฤติกรรม',
    ...
    },
    {
      ...
      speechTh: 'โปรเจกต์บาร์ คือ แถบรายการทางขวามือที่จัดเก็บ Layout, Event Sheet, ภาพ และเสียงทั้งหมดของเกม',
    ...
    },
    {
      ...
      speechTh: 'เลเยอร์ คือ ชั้นของการวางวัตถุซ้อนกันเป็นระดับ เช่น ชั้นฉากหลัง ชั้นตัวละคร และชั้นแสดงผลหัวใจและคะแนน',
      speechEn: 'Layer',
    ...
    },
    {
      ...
      speechTh: 'พารัลแลกซ์ คือ ค่าอัตราการเลื่อนของเลเยอร์เมื่อกล้องเคลื่อนที่ ถ้าตั้งค่าเป็นศูนย์คอมม่าศูนย์ วัตถุจะลอยติดหน้าจอไม่เลื่อนตามตัวละคร',
      speechEn: 'Parallax',
    ...
    },
    {
      ...
      speechTh: 'คอลลิชัน พอลีกอน คือ เส้นกรอบล้อมรอบตัวละครที่ใช้ตรวจจับการชนวัตถุ ต้องปรับให้พอดีกับภาพตัวละครเพื่อไม่ให้ติดขอบกำแพงล่องหน',
    ...
    // ==========================================
    {
      ...
      speechTh: 'ออน สตาร์ต ออฟ เลย์เอาต์ คือ เงื่อนไขที่ทำงานเพียงครั้งเดียวทันทีที่ฉากนั้นถูกเปิดขึ้นมา',
    ...
    },
    {
      ...
      speechTh: 'เอเวอรี ติก คือ เงื่อนไขที่สั่งให้เกมทำงานตลอดเวลาในทุกๆ เฟรมประมาณหกสิบครั้งต่อหนึ่งวินาที',
      speechEn: 'Every tick',
    ...
    },
    {
      ...
      speechTh: 'ทริกเกอร์ วันส์ ไวล ทรู คือ เงื่อนไขล็อกให้การกระทำเกิดขึ้นแค่ครั้งเดียว ไม่รันซ้ำรัวๆ ในทุกเฟรม',
    ...
    },
    {
      ...
      speechTh: 'ออน คอลลิชัน วิด คือ เงื่อนไขตรวจสอบจังหวะที่วัตถุหนึ่งแล่นไปชนหรือแตะกับอีกวัตถุหนึ่ง',
    ...
    },
    {
      ...
      speechTh: 'อิส โอเวอร์แลปปิง คือ เงื่อนไขตรวจสอบว่าวัตถุกำลังแตะหรือซ้อนทับกันอยู่หรือไม่ตลอดเวลาที่ทับกัน',
    ...
    },
    {
      ...
      speechTh: 'คอมแพร์ ทู แวลูส คือ เงื่อนไขเปรียบเทียบตัวเลขหรือตัวอักษรสองค่าว่า มากกว่า น้อยกว่า หรือเท่ากับหรือไม่',
    ...
    },
    {
      ...
      speechTh: 'เอลส์ คือ เงื่อนไขที่จะทำงานก็ต่อเมื่อเงื่อนไขข้างบนก่อนหน้านี้ไม่เป็นจริง',
      speechEn: 'Else',
      usage: 'ใช้ทำทางเลือก เช่น ถ้าตอบคำตอบถูกให้เพิ่มคะแนน แต่ถ้าไม่ถูก (Else) ให้ลดหัวใจ',
      eventExample: {
        type: 'es',
    ...
    },
    {
      ...
      speechTh: 'อิส มูฟวิ่ง คือ เงื่อนไขตรวจสอบว่าตัวละครกำลังเดินหรือเคลื่อนที่อยู่หรือไม่',
      speechEn: 'Is moving',
      usage: 'ใช้สลับแอนิเมชันท่าเดิน walk ให้ตัวละครเวลาผู้เล่นกดลูกศรเดิน',
      eventExample: {
        type: 'es',
    ...
    // ==========================================
    {
      ...
      speechTh: 'เซต โพซิชัน คือ คำสั่งวาร์ปย้ายตัวละครหรือวัตถุไปยังตำแหน่งพิกัด เอ็กซ์ และ วาย ที่กำหนดทันที',
    ...
    },
    {
      ...
      speechTh: 'เซต แอนิเมชัน คือ คำสั่งเปลี่ยนท่าทางการเคลื่อนไหวของตัวละคร เช่น สลับเป็นท่าเดิน ท่ายืน หรือท่ากระโดด',
    ...
    },
    {
      ...
      speechTh: 'สปอว์น อะเนเธอร์ ออบเจกต์ คือ คำสั่งกำเนิดวัตถุชิ้นใหม่ขึ้น ณ ตำแหน่งวัตถุปัจจุบัน',
    ...
    },
    {
      ...
      speechTh: 'เซต มิเรอร์ด คือ คำสั่งกลับด้านภาพตัวละครให้หันหน้าไปทางซ้ายหรือทางขวา',
    ...
    },
    {
      ...
      speechTh: 'แอด ทู และ ซับแทรกต์ ฟรอม คือ คำสั่งบวกเพิ่มหรือลบหักค่าตัวเลขในตัวแปร เช่น เพิ่มคะแนน หรือลดหัวใจ',
    ...
    },
    {
      ...
      speechTh: 'เซต เท็กซ์ คือ คำสั่งเปลี่ยนข้อความตัวหนังสือที่จะแสดงบนหน้าจอ',
      speechEn: 'Set text',
    ...
    },
    {
      ...
      speechTh: 'โก ทู เลย์เอาต์ คือ คำสั่งย้ายการเล่นไปยังฉากใหม่ เช่น เปลี่ยนจากหน้าเมนูเข้าสู่ฉากเกม',
    ...
    // ==========================================
    {
      ...
      speechTh: 'โซลิด คือ พฤติกรรมวัตถุแข็งแน่น ทะลุไม่ได้ ใช้ใส่กับพื้นดิน กำแพง หรือสิ่งกีดขวาง',
    ...
    },
    {
      ...
      speechTh: 'จัมป์ ทรู คือ พฤติกรรมเกาะลอยฟ้า กระโดดทะลุผ่านขึ้นมาจากด้านล่างได้ แต่ยืนเหยียบข้างบนได้',
    ...
    },
    {
      ...
      speechTh: 'สกรอลล์ ทู คือ พฤติกรรมสั่งให้มุมมองกล้องเลื่อนติดตามตัวละครนั้นๆ ไปตลอดทางในฉาก',
    ...
    },
    {
      ...
      speechTh: 'ไซน์ คือ พฤติกรรมทำให้วัตถุเคลื่อนที่โยกสลับไปมาอย่างสม่ำเสมอ เช่น ขยับขึ้นลง หรือลอยซ้ายขวา',
    ...
    },
    {
      ...
      speechTh: 'แฟลช คือ พฤติกรรมสั่งให้ตัวละครกระพริบเข้าออกชั่วคราวเพื่อแสดงสถานะอมตะชั่วขณะหลังโดนโจมตี',
    ...
    },
    {
      ...
      speechTh: 'ดิสทรอย เอาต์ไซด์ เลย์เอาต์ คือ พฤติกรรมที่ลบวัตถุนั้นทิ้งทันทีที่ลอยพ้นขอบฉากออกไป',
    ...
    // ==========================================
    {
      ...
      speechTh: 'โกลบอล แวริเอเบิล คือ ตัวแปรกลางที่เก็บข้อมูลสำคัญและสามารถเรียกใช้หรือแก้ไขร่วมกันได้ในทุกๆ ฉากของเกม',
    ...
    },
    {
      ...
      speechTh: 'อินสแตนซ์ แวริเอเบิล คือ ตัวแปรประจำตัวของวัตถุแต่ละชิ้น ซึ่งวัตถุแต่ละตัวจะมีค่าส่วนตัวไม่ซ้ำกัน',
    ...
    },
    {
      ...
      categoryName: '📊 ตัวแปร & ข้อมูล',
      type: 'Data Structure',
      translation: 'ตารางตารางเก็บข้อมูลหลายๆ ช่อง',
      speechTh: 'อาร์เรย์ คือ ตารางสำหรับจัดเก็บข้อมูลชุดเป็นช่องๆ เหมือนกล่องจดหมายเรียงกัน ช่วยให้จัดการข้อมูลจำนวนมากได้ง่าย',
    ...
    },
    {
      ...
      speechTh: 'เว็บสตอเรจ คือ วัตถุที่ใช้บันทึกข้อมูลคะแนนและด่านที่ผ่านลงในเว็บเบราว์เซอร์ เพื่อให้เปิดกลับมาเล่นต่อได้แม้ปิดคอมพิวเตอร์ไปแล้ว',
    ...
    },
    {
      ...
      speechTh: 'ฟังก์ชัน คือ การรวมกลุ่มคำสั่งที่ใช้บ่อยไว้เป็นก้อนเดียว แล้วตั้งชื่อเรียกใช้ เพื่อลดการเขียนโค้ดซ้ำๆ หลายรอบ',
      speechEn: 'Function object',
      usage: 'ใช้สร้างชุดคำสั่งลดเลือด `ApplyDamage` หรือชุดคำสั่งสร้างโจทย์ `SpawnQuestion` แล้วเรียกใช้จากหลายๆ จุด',
      eventExample: {
        type: 'es',
