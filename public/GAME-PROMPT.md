...
> 📌 ถ้าด้านล่าง (ท้ายข้อความนี้) มีบล็อก **"🎯 ตัวชี้วัดเป้าหมาย"** ให้ออกแบบเนื้อหา/โจทย์/กลไก
> ของเกมให้ฝึกทักษะตามตัวชี้วัดหลักสูตรเหล่านั้นโดยตรง ("ระหว่างทาง" = ฝึกระหว่างเรียน,
> "ปลายทาง" = วัดผลรวบยอด)
