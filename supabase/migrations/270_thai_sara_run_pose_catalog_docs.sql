-- 270_thai_sara_run_pose_catalog_docs.sql
-- game_docs v1.5.0 — pose catalog ครบ + color + auto-fit + pose anchors
...
SELECT i.id, i.owner_staff_id,
       ...
       'v1.5.0',
       'thai-sara-run — pose catalog + color + auto-fit + per-pose foot anchors (44746c8)'
