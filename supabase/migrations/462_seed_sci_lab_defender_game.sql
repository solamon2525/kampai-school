-- 462_seed_sci_lab_defender_game.sql
-- เกม "Sci-Lab Defender AR (ผู้พิทักษ์ห้องแล็บอวกาศ)" (sci-lab-defender)
-- เกม AR วิทยาศาสตร์สำหรับจัดกิจกรรมวันวิทยาศาสตร์ ป.1-6
-- ไฟล์: public/games/science/sci-lab-defender/ · MediaPipe Hands + KAMPAI SDK
...
BEGIN
  ...
  SELECT v_staff_id, v_cat_games, 'link', '🧪 Sci-Lab Defender (AR วันวิทย์)', v_url, 'วิทยาศาสตร์', 462
  WHERE NOT EXISTS (
  ...
  SELECT i.id, i.owner_staff_id,
         'AR/กล้อง (MediaPipe Hands) — ผสาน 3 ฐานกิจกรรมวันวิทยาศาสตร์ (เคมีสสาร, สะท้อนแสงเลเซอร์, พิทักษ์อวกาศ)',
         ARRAY[
