-- ============================================================================
-- Migration 204: Seed "Math Racer" (math-racer)
-- ============================================================================
-- Owner: ครูณัฐพงศ์ สิงห์ชมภู
-- Path: public/games/math/math-racer.html
-- Cover: public/games/math/math-racer-cover.svg
...
DECLARE
  v_staff_id  UUID;
  v_cat_games UUID;
  v_url       TEXT := '/games/math/math-racer.html';
BEGIN
  -- 1. Resolve staff_id
  ...
  SELECT v_staff_id, v_cat_games, 'link', 'Math Racer (High View Racing)', v_url, 'คณิตศาสตร์', 190
  WHERE NOT EXISTS (
  ...
  SELECT i.id, i.owner_staff_id,
         ...
         ARRAY['ซิ่งรถเก็บคำตอบที่ถูกต้องเพื่อเพิ่มคะแนน', 'หลบหลีกคำตอบที่ผิดและรถอุปสรรคคันอื่น', 'โหมดการสุ่มโจทย์เลขคูณและเลขหารฟิสิกส์คลื่นความถี่เสียง', 'รถบรรทุกยักษ์สุ่มบุกบดขยี้ทางวิ่งแบบกะทันหัน', 'รองรับโหมดผู้เล่นเดี่ยว หรือผู้เล่นคู่ดวลความเร็วร่วมจอ'],
         'v1.0.0',
         'สร้างเกมครั้งแรก'
