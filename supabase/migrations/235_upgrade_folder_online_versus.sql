-- 235_upgrade_folder_online_versus.sql
-- อัปเกรดเกมออนไลน์แบบโฟลเดอร์ (5 ไฟล์) จาก KampaiMatch → KampaiVersus
-- → เพิ่มโหมด "2 คนเครื่องนี้" (local hot-seat) · onPlay เดิม (startGame('online',rng)) ใช้ได้ทั้งสองโหมด
...
DECLARE
  ...
  v_urls TEXT[] := ARRAY[
    '/games/career/veggie-garden/index.html',
    '/games/english/listen-spell/index.html',
    '/games/math/math-rally/index.html',
    '/games/science/sink-float/index.html'
  ];
BEGIN
