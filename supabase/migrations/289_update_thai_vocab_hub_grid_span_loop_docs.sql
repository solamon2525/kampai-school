-- ============================================================================
-- Migration 289: Thai Vocab Hub v1.7.3 — grid span refit width-only (fix layout loop)
-- ============================================================================
...
BEGIN
  ...
  VALUES (
    ...
    ARRAY[
      ...
      'lifecycle: หยุด TTS/autoplay เมื่อออกเกม ซ่อนแท็บ หรือ navigate',
      'กริด span: refit เฉพาะเมื่อความกว้างเปลี่ยน — กันลูปกระตุกจากความสูง/พลิกการ์ด'
    ],
    'v1.7.3',
    'Width-only ResizeObserver + gridSpanFitting lock (fix infinite grid layout jank)'
  )
