...
INSERT INTO testimonials (name, role, quote, rating, order_position) VALUES
  ...
  ('น้องพิม ป.6',       'นักเรียน',   'ชอบกิจกรรมที่หลากหลาย ทำให้ได้เรียนรู้นอกห้องเรียน ครูทุกคนเป็นกันเอง',     5, 2),
...
INSERT INTO partners (name, logo_url, link_url, order_position) VALUES
  ('กระทรวงศึกษาธิการ', '/logos/moe.png', 'https://www.moe.go.th',       1),
  ('สพฐ.',              '/logos/obec.png', 'https://www.obec.go.th',      2),
  ('สพท.',              '/logos/garuda.png', '#',                            3),
  ('ท้องถิ่น',          '/logos/garuda.png', '#',                            4)
ON CONFLICT DO NOTHING;
