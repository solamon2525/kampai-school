-- 333: cache bust ปกเกม 5 รายการ → ?v=3
UPDATE public.educational_hub_items
SET thumbnail_url = '/games/math/multiply-burst/cover.png?v=3', updated_at = now()
WHERE game_slug = 'multiply-burst'
   OR external_url = '/games/math/multiply-burst/index.html';

UPDATE public.educational_hub_items
SET thumbnail_url = '/games/math/catch-numbers/cover.png?v=3', updated_at = now()
WHERE game_slug = 'catch-numbers'
   OR external_url = '/games/math/catch-numbers/index.html';

UPDATE public.educational_hub_items
SET thumbnail_url = '/games/math/math-rally/cover.png?v=3', updated_at = now()
...
UPDATE public.educational_hub_items
SET thumbnail_url = '/games/math/net-3d-cover.png?v=3', updated_at = now()
WHERE game_slug = 'net-3d'
   OR external_url = '/games/math/net-3d.html';

UPDATE public.educational_hub_items
SET thumbnail_url = '/games/thai/ai-hand-gesture-game-cover.png?v=3', updated_at = now()
