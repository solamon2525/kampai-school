-- ============================================================================
-- Migration 203: Seed "Super Math-Blaster" (math-blaster)
-- ============================================================================
-- Owner: ครูณัฐพงศ์ สิงห์ชมภู
-- Path: public/games/math/math-blaster.html
...
DECLARE
  v_staff_id  UUID;
  v_cat_games UUID;
  v_url       TEXT := '/games/math/math-blaster.html';
BEGIN
  -- 1. Resolve staff_id
  ...
  SELECT v_staff_id, v_cat_games, 'link', 'Super Math-Blaster: Galactic Duel', v_url, 'คณิตศาสตร์', 180
  WHERE NOT EXISTS (
  ...
  SELECT i.id, i.owner_staff_id,
         'เกมยิงอวกาศ เลือกทำลายอุกกาบาตเพื่อตอบโจทย์คณิตศาสตร์',
         ARRAY['ยิงทำลายอุกกาบาตเพื่อตอบโจทย์คณิตศาสตร์', 'ระบบการเล่นแบบคลื่นศัตรู ตัวสุ่มโจทย์ และบอสท้ายด่าน', 'ไอเทมพิเศษ บัฟเกราะ ปืนกระจาย และปืนนำวิถี', 'รองรับการเล่น 2 คน (Co-op) บนหน้าจอเดียวกัน'],
         'v1.0.0',
         'สร้างเกมครั้งแรก'
