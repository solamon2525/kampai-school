-- ============================================================================
-- Migration 285: Thai Vocab Hub v1.7.1 — flash deck, listen, practice missed, grid back expand
-- ============================================================================
...
BEGIN
  ...
  VALUES (
    ...
    'v1.7.1',
    'Flash deck + listen + practice missed + category-aware quiz + grid back-face expand (เฟส H)'
  )
