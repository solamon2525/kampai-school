-- 347: Seed Thai Poetry Hub — บทร้อยกรรม ป.4-5 (media)

DO $$
DECLARE v_staff_id UUID; v_cat_media UUID; v_item_id UUID;
  v_url TEXT := '/games/thai/thai-poetry-hub/index.html';
BEGIN
  ...
  SELECT v_staff_id, v_cat_media, 'link',
    '🎭 คลังบทร้อยกรรมไทย — แก้ว · กรอง · คำขวัญ',
    'สื่อการสอนภาษาไทย ป.4-5: บทร้อยแก้ว บทร้อยกรอง คำขวัญ สัมผัส ฉันทลักษณ์ — ท่องบท TTS · ตอบคำถาม',
    v_url, '/games/thai/thai-poetry-hub/cover.png', 'ภาษาไทย',
    ARRAY['ป.4','ป.5'], ARRAY['บทร้อยกรอง','คำขวัญ','สัมผัส','วรรณคดี'], 92, false, true
  ...
  UPDATE public.educational_hub_items SET
    title = '🎭 คลังบทร้อยกรรมไทย — แก้ว · กรอง · คำขวัญ',
    description = 'สื่อการสอนภาษาไทย ป.4-5: บทร้อยแก้ว บทร้อยกรอง คำขวัญ สัมผัส ฉันทลักษณ์ — ท่องบท TTS · ตอบคำถาม',
    thumbnail_url = '/games/thai/thai-poetry-hub/cover.png', sort_order = 92,
  ...
  VALUES (v_item_id, v_staff_id, 'คลังบทร้อยกรรมไทย ป.4-5',
    ARRAY['7 หมวด 36 รายการ','ท่องบท TTS','สัมผัสใกล้/ไกล','ท 5.1 ป.4/4'], 'v1.0.0', 'TEACHING-MEDIA-IDEAS #4')
