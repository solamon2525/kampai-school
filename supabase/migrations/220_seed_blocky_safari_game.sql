...
BEGIN
  ...
  SELECT i.id, i.owner_staff_id,
         'เกมยิงกู้ภัยและจำแนกกลุ่มสัตว์ 3D (Shooter) ด้วย Three.js สะสมคะแนนข้าม 3 ด่าน',
         ARRAY[
           'วิชาวิทยาศาสตร์ ป.4 เรื่องการจำแนกกลุ่มสัตว์ (สัตว์เลี้ยงลูกด้วยนม สัตว์ปีก สัตว์เลื้อยคลาน สัตว์สะเทินน้ำสะเทินบก และปลา)',
           'เป้าหมายจำแนกประเภทแบบไดนามิก เช่น ให้ล่า/เก็บเฉพาะกลุ่มสัตว์ปีก หรือสัตว์เลื้อยคลานตามคำสั่ง',
           'ระบบยิงกระสุน 3D (Spacebar/คลิกหน้าจอ) เพื่อกู้ภัยสัตว์เลี้ยง ยิงถูกได้คะแนน ยิงผิดเสียหัวใจพลังชีวิต',
           'มอนสเตอร์สัตว์ป่าค่อยๆ เลื้อยเดินไล่ล่าตามผู้เล่น โดนชนลดหัวใจ (มีหัวใจ 5 ดวงและเกราะอมตะกะพริบตัวชั่วคราว)',
           'ผูกติดกับระบบคะแนนสูงสุดและสถิติผ่าน KAMPAI SDK และแสดงอันดับในโรงเรียนด้วย Leaderboard'
         ],
         'v2.0.0',
         'ปรับปรุงเมคานิกส์เป็นแนว 3D Shooter ยิงแยกแยะสัตว์และหลบหลีกการชนไล่ล่า (มี 5 หัวใจ)'
