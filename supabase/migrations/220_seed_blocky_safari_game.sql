...
BEGIN
  ...
  SELECT i.id, i.owner_staff_id,
         'เกมสำรวจป่า 3D ด้วย Three.js และตอบคำถามจำแนกประเภทกลุ่มสัตว์ ป.4',
         ARRAY[
           ...
           'คลังความรู้และชุดคำถามจำแนกประเภทสำหรับสัตว์ป่า 5 ชนิดหลัก',
           'ระบบตอบคำถามพร้อมการวิเคราะห์ใบ้คำถามและประเมินผลการเรียนรู้แบบมีคำแนะนำ',
         ...
         'v1.0.0',
         'นำเข้าเกมใหม่ — Blocky Safari สุดยอดนักสำรวจพิทักษ์สัตว์โลก ป.4'
