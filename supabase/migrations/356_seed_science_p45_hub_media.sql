-- 356: Seed Science P45 Hub (media)

DO $$
DECLARE v_staff_id UUID; v_cat_media UUID; v_item_id UUID;
  v_url TEXT := '/games/science/science-p45-hub/index.html';
BEGIN
  ...
  SELECT v_staff_id, v_cat_media, 'link', '🔬 คลังวิทยาศาสตร์ ป.4-5 — สสาร · น้ำ · สัตว์ · ย่อย',
    'สื่อการสอนวิทยาศาสตร์ ป.4-5: สถานะสสาร วัฏจักรน้ำ จำแนกสัตว์ ระบบย่อยอาหาร · รวมชิ้นกระจาย',
    v_url, '/games/science/science-p45-hub/cover.png', 'วิทยาศาสตร์', ARRAY['ป.4','ป.5'], ARRAY['สสาร','วัฏจักรน้ำ','สัตว์','ร่างกาย'], 98, false, true
  WHERE NOT EXISTS (SELECT 1 FROM public.educational_hub_items WHERE owner_staff_id = v_staff_id AND external_url = v_url);
  UPDATE public.educational_hub_items SET title = '🔬 คลังวิทยาศาสตร์ ป.4-5 — สสาร · น้ำ · สัตว์ · ย่อย',
    thumbnail_url = '/games/science/science-p45-hub/cover.png', sort_order = 98,
  ...
  VALUES (v_item_id, v_staff_id, 'คลังวิทย์ ป.4-5', ARRAY['สถานะสสาร','วัฏจักรน้ำ','สัตว์มีกระดูก','ระบบย่อย'], 'v1.0.0', 'TEACHING-MEDIA-IDEAS #15')
