-- Migration 424: vocab-hub Math Question — clearer slower chunked English TTS
DO $$
DECLARE
  v_item_id UUID;
BEGIN
  ...
  SELECT
    ...
    ARRAY[
      ...
      'อ่านทีละช่วงช้าและชัด: What is → เลขคำ → plus/minus/times/divided by → เลขคำ',
    ...
    'v2.3.2',
    'ปรับ TTS Math Question ให้อ่านเลขเป็นคำอังกฤษ ช้าลง และเว้นจังหวะทีละช่วง ฟังง่ายขึ้นสำหรับประถม'
