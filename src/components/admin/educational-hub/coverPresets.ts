...
export const COVER_GROUPS: CoverGroup[] = [
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'male_teacher_thai', label: 'ครูผู้ชายไทย', fragment: 'main character: a friendly male Thai elementary school teacher, short neat hair, light blue polo shirt with dark trousers, warm smile, pointing at whiteboard with marker — clearly male, NOT female' },
