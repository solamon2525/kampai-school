...
import { Plus, Search, Pencil, Trash2, Paperclip, SendHorizontal, PenLine, Upload } from 'lucide-react';
                                ...
                                <tbody className="divide-y divide-border">
                                    {filtered.map(l => (
                                        <tr key={l.id} className="hover:bg-secondary/30 transition-colors">
                                            ...
                                            <td className="px-4 py-3 whitespace-nowrap">{formatThaiDateFull(l.sent_date)}</td>
