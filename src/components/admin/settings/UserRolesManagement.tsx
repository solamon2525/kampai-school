    ...
    const togglePermission = async (userId: string, menuId: string) => {
        ...
        if (error) {
            ...
            toast({
                ...
                description: 'สิทธิ์ใหม่ได้รับการปรับใช้อย่างสมบูรณ์และมีผลกับคุณครูทันทีแบบเรียลไทม์!',
            });
        }
    };
    ...
    const grantAllPermissions = async (userId: string) => {
        ...
        if (error) {
            ...
            toast({
                ...
                description: 'ครูคนนี้สามารถใช้งานได้ทุกเมนูหลังบ้าน โดยมีผลทันทีแบบเรียลไทม์!',
            });
        }
    };
    ...
    const revokeAllPermissions = async (userId: string) => {
        ...
        if (error) {
            ...
            toast({
                ...
                description: 'สิทธิ์ถูกถอนออกและมีผลทันทีแบบเรียลไทม์!',
            });
        }
    };
