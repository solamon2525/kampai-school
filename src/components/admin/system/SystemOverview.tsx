...
const versionHistory = [
    {
        version: 'v1.89.0 (Angle Castle — เกมคณิตศาสตร์มุมสะท้อน ป.4)',
        date: 'ล่าสุด',
        badge: 'bg-emerald-600',
        items: [
            'สร้างเกมแนววัดมุมเรขาคณิตและแก้ปัญหาฟิสิกส์ชิ่งสะท้อนกระจก ชื่อ Angle Castle (ศึกปราสาทมุมองศา) รูปแบบ 5 ไฟล์ (index.html, style.css, config.js, data.js, game.js) บน HTML5 Canvas',
            'ติดตั้งแผงชาร์จไม้โพรแทรกเตอร์เรืองแสงนีออนรอบตัวละคร แสดงขีดสเกลและระบุประเภทมุมตามหลักวิชาการเรขาคณิต (มุมแหลม, มุมฉาก, มุมป้าน, มุมตรง, มุมกลับ) แบบเรียลไทม์ 📐',
            'เขียนระบบเส้นคาดการณ์และคำนวณการเดินทางของแสงสะท้อน (Reflection Path Solver) สะท้อนกับกระจกเงาด้านข้างและกระจกที่ผู้เล่นหมุนจัดมุมได้ 🪞',
            'รองรับคทาเวทมนตร์ 3 ชนิด: คทาสะท้อนดวงดาว, คทาสามแฉก และคทาเลเซอร์นำแสง เพื่อความหลากหลายทางกลยุทธ์',
            'ผูกระบบเสียงอ่านวิชาการภาษาไทย (Thai TTS Assistant) ออกเสียงประเภทและขนาดองศาของมุมเมื่อกดเล็งยิงโดนเป้าหมายที่ถูกต้อง',
            'สร้าง Migration 191_seed_angle_castle_game.sql เชื่อมโยงตัวชี้วัด ป.4 คณิตศาสตร์ (ค 2.2 ป.4/1, ค 2.1 ป.4/2) ลงทะเบียนในคลังของครูณัฐพงศ์ สิงห์ชมภู',
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            ...
            'ติดตั้งระบบป้อมเซลล์เม็ดเลือดขาว 3 ชนิด: นิวโทรฟิล 🛡️ (ยิงเดี่ยวไว), แมคโครฟาจ 🌀 (คลื่นคลุมกลืนกิน AOE), และบีเซลล์ 🧬 (ยิงแอนติบอดีสโลว์ศัตรู 40%)',
            'เพิ่มระบบปุ่มตอบคำถามควิซคลังสุขศึกษาและวิทยาศาสตร์สุ่ม 30 ข้อ เพื่อกู้พลังงานชีวภาพ 🔋 นำมาสร้างป้อม พร้อมเสียงอ่านโจทย์ภาษาไทย (TTS)',
            'ใส่ฟีเจอร์พรีเมียมจัดเต็ม: ท่าไม้ตาย ระเบิดยาปฏิชีวนะ 💊 ล้างจอศัตรู, โซนบัฟพลังงานจากสารอาหารวิตามินสุ่มกลางด่าน, และวงกลมเมนูคลิกป้อมเพื่ออัปเกรด/ขาย',
            'รองรับการแข่งออนไลน์แบบเรียลไทม์โดยซิงโครไนซ์ตำแหน่งสิ่งกีดขวางและเชื้อโรคบุกด้วย Seeded RNG ผ่าน KampaiMatch พร้อมแอนิเมชันสถานะแช่แข็งสีฟ้า',
            'สร้าง Migration 189_seed_bio_defense_game.sql สำหรับผูกเกมเข้าระบบ Educational Hub ในหมวดวิชาสุขศึกษาและพลศึกษา ของครูณัฐพงศ์ สิงห์ชมภู',
        ],
    },
    {
