...
const versionHistory = [
    {
        ...
        badge: 'bg-teal-600',
        items: [
            'math-runner บนมือถือ: **บังคับเล่นแนวนอน** — จอแนวตั้งขึ้นป้าย "หมุนเครื่องเป็นแนวนอน" + หยุดเวลา/เกมชั่วคราว (กลับแนวนอน = เล่นต่อ) · ตรวจ orientation ด้วย `matchMedia` + เช็คซ้ำหน่วงเวลา (กันขนาดอัปเดตช้า) · **มีปุ่ม "▶ เริ่มเล่นเลย" กันค้าง** (เครื่องล็อกหมุน/อยู่ในกรอบไม่หมุน) — เดสก์ท็อปไม่กระทบ',
