...
const versionHistory = [
    {
        ...
        badge: 'bg-teal-600',
        items: [
            'math-runner บนมือถือ: **บังคับเล่นแนวนอน** — จอแนวตั้งขึ้นป้าย "หมุนเครื่องเป็นแนวนอน" คลุมจอ + หยุดเวลา/เกมชั่วคราว (กลับแนวนอน = เล่นต่อ) · ตรวจด้วย `pointer: coarse` (มือถือ/แท็บเล็ต) — เดสก์ท็อปไม่กระทบ',
