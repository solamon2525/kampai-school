...
const versionHistory = [
    {
        version: 'v1.47.2 (หน้าจบเกม — การ์ด XP ลอยไม่ตัดหน้า + หน่วงให้อ่านอันดับทัน)',
        date: 'ล่าสุด',
        badge: 'bg-sky-600',
        items: [
            'เดิมจบเกมแล้วเด้งหน้า +XP ทับทันที (unmount เกม) → อ่านจอจบเกม/อันดับไม่ทัน รู้สึก "ตัดหน้า"',
            'ตอนนี้เกมโชว์จอจบของตัวเองต่อ แล้วการ์ด XP เล็ก ๆ ลอยขึ้นมุมล่าง (ไม่มี backdrop ไม่บังจอ) — หน่วง 5 วิ สำหรับโหมดเดี่ยว, ออนไลน์เด้งทันที (กด "รับ XP" เองอยู่แล้ว)',
            'การ์ด auto-hide ใน 8 วิ (หยุดนับเมื่อชี้เมาส์ค้าง) + ปุ่ม เล่นซ้ำ/ปิด — แก้ทีเดียวที่ PlayGame wrapper มีผลทุกเกม',
        ],
    },
    {
