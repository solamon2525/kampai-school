...
const versionHistory = [
    {
        ...
        items: [
            ...
            'Compact Hero Sections (7 หน้า public): staff/about/waste-bank/curriculum/students/news/contact ลด hero จาก ~280-400px เหลือ ~96-128px (60-70% ลด) + standard pattern เดียวกัน (`bg-primary py-6 md:py-8`) + ไม่มี gradient (Rule 14.1) — Staff เลิกใช้ navy palette เปลี่ยนเป็น green ตาม brand',
