...
8. **โหมดตามวัตถุประสงค์การสอน (Teaching Purpose Modes):**
   ...
   - ใบงานการหารยาว (`division-worksheet.html`) ใช้ 5 ข้อต่อหน้าเท่านั้น และใช้กระดานตั้งหารยาวจริง: ตัวหารอยู่ซ้าย ตัวตั้งอยู่ใต้เส้น ผลหาร ผลคูณ ผลลบ และเลขที่ดึงลงต้องตรงคอลัมน์ค่าประจำหลักเดียวกัน ห้ามแยกเป็นป้าย “ขั้น 1/ขั้น 2” หรือสมการข้อความข้างกระดาน
   - ใบงานหารสั้น (`short-division-worksheet.html`) จับคู่สื่อ `short-division-thinking-media.html`: กระดานหารสั้นจริง (ตัวหาร `)` ตัวตั้ง · เส้นใต้ผลหาร · ช่องทดเศษตัวเล็กหน้าหลักถัดไป) — ค่าเริ่มต้น **5 ข้อ/หน้า**; ห้ามลดเหลือแค่ `calc-line` สมการข้อความแทนกระดาน
...
- ภาษา → ช่องจำแนกคำ/ส่วนประกอบประโยคตามสิ่งที่วัด (ไทย: หลักฐาน+ติ๊กใจความ · แผนเขียน · S→V→O · word-bank; อังกฤษ: evidence · verb-cmd Circle/Underline/Tick · sound-box/word-bank ตามทักษะ)
